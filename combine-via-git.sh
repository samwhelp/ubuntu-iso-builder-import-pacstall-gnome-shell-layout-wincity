...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-gnome-shell-layout-wincity"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-gnome-shell-layout-wincity/iso-profile
"
echo
